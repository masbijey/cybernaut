    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @if(!in_array(Auth::user()->role->beo, ['1', '2', '3']))
                        @else
                        <a class="collapse-item" href="#">BEO</a>
                        @endif

                        @if(!in_array(Auth::user()->role->voucher, ['1', '2', '3']))
                        @else
                        <a class="collapse-item" href="#">E-Voucher</a>
                        @endif
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('workorder.index')}}">Work Order</a>
            ...
            <li class="nav-item">
                ...
                <div id="asset" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Components:</h6>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Cybernaut Unit 2023</span>
                    </div>
                </div>
            </footer>
        </div>
