...
@section('content')
<div class="mb-2">
    <h4 class="d-inline bg-white text-dark">Detail task :</h4> <br>
    <h3 class="text-primary d-inline">{{ $task->task_desc }}</h3>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" class="form-control form-control-sm" id="price" name=""
                                value="{{ $task->task_price }}" disabled>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <textarea name="" id="remark" class="form-control form-control-sm"
                                disabled>{{ $task->task_remark }}</textarea>
            ...
            <div class="card-body">
                <table class="table table-borderless">
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm" id="task_vendor" name=""
                                disabled value="{{ $task->task_vendor }}">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" class="form-control form-control-sm" id="task_vendor_phone"
                                name="" disabled value="{{ $task->task_vendor_phone}}">
                        </td>
                    </tr>
                </table>
                @if ($task->task_status != 'Done')
