...
@section('content')
<h1 class="h3 mb-4 text-gray-800">NEW WORK ORDER</h1>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('workorder.store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-multiple custom-select form-control form-control-sm"
                            id="tag-department" name="department_ids[]" multiple="multiple">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="Low" name="priority" class="custom-control-input"
                                value="Low" required>
                            <label class="custom-control-label " for="Low">Low</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="Medium" name="priority" class="custom-control-input"
                                value="Medium" required>
                            <label class="custom-control-label" for="Medium">Medium</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="High" name="priority" class="custom-control-input"
                                value="High" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-multiple custom-select form-control form-control-sm"
                            id="tag-asset" name="asset_ids[]" multiple="multiple">
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-multiple custom-select form-control form-control-sm"
                            id="tag-location" name="asset_ids[]" multiple="multiple">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('workorder.store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-info">*dapat tambahkan lebih banyak file setelah wo dibuat.</small>
                    </div>
